...
/// - localizationKey: Grid.scene
public class Grid: SKScene {
    // MARK: Private properties
    
    /// The amount of columns in the grid.
    /// - localizationKey: Grid.columnCount
    public let columnCount: Int

    /// The amount of rows in the grid.
    /// - localizationKey: Grid.rowCount
    ...
    /// - localizationKey: Grid.coordinateIsValid(_:)
    ...
    ///
    /// - returns: The ``Tile`` at the given row and column.
    /// - localizationKey: Grid.tileAt(row:column:)
    ...
    /// - localizationKey: Grid.randomCoordinate(withState:)
    ...
    /// - localizationKey: Grid.coordinates(withState:)
...
extension Grid: TileInteractionDelegate {
    func didTouchTile(_ tile: Tile) {
        gridDelegate?.grid(self, didTouch: tile.coordinate)
    }
}
