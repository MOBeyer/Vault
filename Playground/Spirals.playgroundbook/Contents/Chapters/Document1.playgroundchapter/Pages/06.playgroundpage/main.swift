...
//#-editable-code
//#-localizable-zone(page06k01)
// This needs to be twice as long as the wheelRadius
//#-end-localizable-zone
trackRadius = <#T##radius##Double#>

//#-localizable-zone(page06k02)
// Is the wheelRadius for a hypotrochoid positive or negative?
//#-end-localizable-zone
wheelRadius = <#T##radius##Double#>

//#-localizable-zone(page06k03)
// Make sure this isn’t equal to the wheelRadius!
//#-end-localizable-zone
spokeLength = <#T##length##Int#>

//#-localizable-zone(page06k04)
// And customize!
//#-end-localizable-zone
pathColor = #colorLiteral(red: 0.002151125809, green: 0.617736578, blue: 0.8608769774, alpha: 1)
trackColor = #colorLiteral(red: 0.8941176471, green: 0.2117647059, blue: 0.2431372549, alpha: 1)
spokeColor = #colorLiteral(red: 0.3823705912, green: 0.7347578406, blue: 0.2736029625, alpha: 1)
