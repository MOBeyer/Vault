...
//#-editable-code
//#-localizable-zone(page04k02)
// Try using a value like 6.2 or 2.4 - you get different shapes with fractional numbers.
//#-end-localizable-zone
trackRadius = 5.0
wheelRadius = 3.0

//#-localizable-zone(page04k03)
// Customize all your colors!
//#-end-localizable-zone
pathColor = #colorLiteral(red: 0.3823705912, green: 0.7347578406, blue: 0.2736029625, alpha: 1)
trackColor = #colorLiteral(red: 0.002151125809, green: 0.617736578, blue: 0.8608769774, alpha: 1)
spokeColor = #colorLiteral(red: 0.5882352941, green: 0.2392156863, blue: 0.5921568627, alpha: 1)
wheelColor = #colorLiteral(red: 0.9607843137, green: 0.5098039216, blue: 0.1215686275, alpha: 1)

//#-localizable-zone(page04k04)
