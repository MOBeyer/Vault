...
//#-editable-code
//#-localizable-zone(page05k01)
// To create an epitrochoid, you need to change this value:
//#-end-localizable-zone
wheelRadius = 3

//#-localizable-zone(page05k02)
// Remember, now that you’re working with trochoids, the spokeLength is flexible. Change it up!
//#-end-localizable-zone
spokeLength = 5

//#-localizable-zone(page05k03)
// Have fun customizing!
//#-end-localizable-zone
trackRadius = 5
pathColor = #colorLiteral(red: 0.9607843137, green: 0.5098039216, blue: 0.1215686275, alpha: 1)
trackColor = #colorLiteral(red: 0.5882352941, green: 0.2392156863, blue: 0.5921568627, alpha: 1)
spokeColor = #colorLiteral(red: 0.8941176471, green: 0.2117647059, blue: 0.2431372549, alpha: 1)
wheelColor = #colorLiteral(red: 0.002151125809, green: 0.617736578, blue: 0.8608769774, alpha: 1)
