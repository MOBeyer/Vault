...
class ViewController: UIViewController, WKNavigationDelegate {
    var webView: WKWebView! //why implicitly unwrapped?
    var progressView: UIProgressView! //progress View
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.hackingwithswift.com" + websites[0])!
